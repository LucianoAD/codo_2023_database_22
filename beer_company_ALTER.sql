...
ALTER TABLE beer 
ADD CONSTRAINT fk_category_beer
FOREIGN KEY (id_category) REFERENCES beer_category(id_category);

INSERT INTO beer_category values(
 NULL , 'premium',1,'stout'
);

INSERT INTO beer  values
(
    NULL, 'Stella Artois','12.4', "./some/path", DEFAULT,DEFAULT,DEFAULT,1
